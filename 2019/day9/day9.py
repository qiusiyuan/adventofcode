...
def process(machine_code, inputs):
    curr = 0
    i = 0
    relative_base = 0
    while machine_code[curr] != '99':
        ...
        if op[-1] == '1' or op[-1] == '2' or op[-1] == '7' or op[-1] == '8':
            ...
            input_param = op[0]
            if input_param == '1':
                print("output", machine_code.get(curr+1, '0'))
            elif input_param == '0':
                print("output", machine_code.get(int(machine_code.get(curr + 1, '0')), '0'))
            elif input_param == '2':
                print("output", machine_code.get(int(machine_code.get(curr + 1, '0')) + relative_base, '0'))
            curr += 2
